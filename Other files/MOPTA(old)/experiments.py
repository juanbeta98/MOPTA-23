...
for t_max in range(2):
    ...
    sys.stdout = open("./Experiment1.txt", "a")
    print(n, t_max,  round(total_time,2), round(initialization_time,2), round(column_generation_time,2), round(simulation_time,2), round(Z_IS,2), round(Z_LP,2), round(Z_IP,2), sep =",")
    sys.stdout = original
