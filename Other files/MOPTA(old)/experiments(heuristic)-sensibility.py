...
for test in ["A","B","C"]:
    ...
    sys.stdout = open("./Experiment2.txt", "a")
    print(test, n, c_f, c_o, c_t, round(fixed_cost,2), round(overtime_cost,2), round(travel_time_cost,2), round(Z_IP,2), number_of_routes, round(total_time,2), sep =",")
    sys.stdout = original
